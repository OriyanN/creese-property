                    ...
                    <ol className="privacy-section">
                        ...
                        <li className="heading-privacy">
                            ...
                            <ol className="text privacy-section">
                                ...
                                <br />
                                <li>
                                    Creese Property Pty Ltd may contact you by a variety of measures including, but not limited to telephone, email, sms or mail.
                                </li>
                                <br />
                            </ol>
                        </li>
                        ...
                        <li className="heading-privacy">
                            ...
                            <ol className="text privacy-section">
                                ...
                                <br />
                                <li>
                                    We may also use your personal information to protect the copyright, trademarks, legal rights, property or safety of Creese Property Pty Ltd, its customers or third parties.
                                </li>
                                <br />
                                <li>
                                    Information that we collect may from time to time be stored, processed in or transferred between parties located in countries outside of Australia. These may include, but are not limited to USA, India and Hong Kong.
                                </li>
                                <br />
                                <li>
                        ...
                        <li className="heading-privacy">
                            ...
                            <ol className="text privacy-section">
                                <li>
                                    ...
                                    <br />
                                    When you come to our website (www.creeseproperty.com) we may collect certain information such as browser type, operating system, website visited immediately before coming to our site, etc. This information is used in an aggregated manner to analyse how people use our site, such that we can improve our service.
                                </li>
                                <br />
                                <li>
                                    Cookies
                                ...
                                <li>
                                    Third party sites
                                    <br />
                                    Our site may from time to time have links to other websites not owned or controlled by us. These links are meant for your convenience only. Links to third party websites do not constitute sponsorship or endorsement or approval of these websites. Please be aware that Creese Property Pty Ltd is not responsible for the privacy practises of other such websites. We encourage our users to be aware, when they leave our website, to read the privacy statements of each and every website that collects personal identifiable information.
                                </li>
                                <br />
                            </ol>
                        </li>
