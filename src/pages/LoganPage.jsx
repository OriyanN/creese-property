...
import mainInitialImage from "../assets/logan.jpg";
    ...
    return (
        <section className="section location">
            ...
            <div className="initial-image">
                <img src={locationInfo.mainImage} alt="Logan" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            ...
            <div className="images-container">
                {filteredImages.length > 0 ? (
                    ...
                    <div key={image.address} className="image-item-container">
                        <img src={image.url} alt={`Logan ${index}`} className="image-item" />
