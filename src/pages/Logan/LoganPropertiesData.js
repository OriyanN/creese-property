...
const LoganPropertiesData = [
  {
    id: 'log1',
    images: Object.values(log1Images),
    address: '506-514 Beenleigh Redland Bay Road, Carbrook',
    beds: 4,
    baths: 2,
    car: 2,
    features: ['Air conditioning', 'Built-in wardrobes', 'Ensuite', 'Study', 'Dishwasher', 'Deck', 'Balcony', 'Water tank', 'Outdoor area', 'Solar panels', 'Pets conceded'],
  ...
  {
    id: 'log2',
    images: Object.values(log2Images),
    address: '5 Sunrise Court, Loganlea',
    beds: 3,
    baths: 2,
    car: 2,
