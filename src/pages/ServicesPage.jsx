                ...
                <div className="services-container">
                    ...
                    <div className="services">
                        <div className="service">
                            <img src="src/assets/1.png" height={100} alt="Creese Property Tailored Solutions" />
                        ...
                        <div className="service">
                            <img src="src/assets/2.png" height={100} alt="Creese Property Expert Advice" />
                            <h3>Expert Advice</h3>
                        ...
                        <div className="service">
                            <img src="src/assets/3.png" height={100} alt="Creese Property Community Focus" />
