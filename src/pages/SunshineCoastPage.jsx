...
import mainInitialImage from "../assets/sunshine-coast1.png";
...
const SunshineCoastPage = () => {
    ...
    const locationInfo = {
        ...
        images: [
            ...
            {
                url: image1,
                address: "Address 4, Sunshine Coast",
                beds: 6,
                baths: 7,
                parking: 4,
            },
            {
                url: image2,
                address: "Address 5, Sunshine Coast",
                beds: 7,
                baths: 8,
                parking: 5,
            },
    ...
    return (
        <section className="section location">
            ...
            <div className="initial-image">
                <img src={locationInfo.mainImage} alt="Sunshine Coast" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            ...
            <div className="images-container">
                {filteredImages.length > 0 ? (
                    ...
                    <div key={image.address} className="image-item-container">
                        <img src={image.url} alt={`Sunshine Coast ${index}`} className="image-item" />
