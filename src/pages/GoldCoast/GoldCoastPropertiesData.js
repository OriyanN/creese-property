import * as gc1Images from '../../assets/GoldCoast/gc1';
import * as gc2Images from '../../assets/GoldCoast/gc2';

const GoldCoastPropertiesData = [
  {
    id: 'gc1',
    images: Object.values(gc1Images),
    address: '4/48 Macadie Way, Merrimac',
    beds: 4,
    baths: 2,
    car: 2,
    features: ['Air conditioning', 'Built-in wardrobes', 'Ensuite', 'Study', 'Dishwasher', 'Deck', 'Balcony', 'Water tank', 'Outdoor entertaining area', 'Solar panels'],
  ...
  {
    id: 'gc2',
    images: Object.values(gc2Images),
    address: '128 Salerno Street, Surfers Paradise',
    beds: 3,
    baths: 2,
    car: 2,
    features: ['Air conditioning', 'Built-in wardrobes', 'Ensuite', 'Study', 'Dishwasher', 'Deck', 'Balcony', 'Water tank', 'Outdoor entertaining area', 'Solar panels'],
  ...
  },
  {
    id: 'gc3',
    images: Object.values(gc2Images),
    address: '8/95 Johnston Street, Southport',
    beds: 5,
    baths: 3,
    car: 3,
    features: ['Air conditioning', 'Built-in wardrobes', 'Ensuite', 'Study', 'Dishwasher', 'Deck', 'Balcony', 'Water tank', 'Outdoor entertaining area', 'Solar panels'],
  ...
  },
  {
    id: 'gc4',
    images: Object.values(gc1Images),
    address: '1/13 Morotai Avenue, Palm Beach',
    beds: 4,
    baths: 2,
    car: 2,
    features: ['Air conditioning', 'Built-in wardrobes', 'Ensuite', 'Study', 'Dishwasher', 'Deck', 'Balcony', 'Water tank', 'Outdoor entertaining area', 'Solar panels'],
