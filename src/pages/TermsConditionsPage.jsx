            ...
            <div>
                <div className="privacy">
                    ...
                    <div className="terms-conditions">
                        ...
                        <br />
                        <p>
                            Welcome to the Creese Property website at www.creeseproperty.com (the Website).
                            <br />
                            <br />
                    ...
                    <ol className="privacy-section">
                        ...
                        <li className="heading-privacy">
                            ...
                            <ol className="text privacy-section">
                                ...
                                <br />
                                <li>
                                    We may not have not checked floor area, property size, property descriptions and other information published on the Website about any property.
                                </li>
                                <br />
                                <li>
                                    Prior to making any decision about any property advertised on the Website, you must independently verify any information about the property that you intend to rely on.
                                </li>
                            </ol>
                        </li>
                        <br />
                        ...
                        <li className="heading-privacy">
                            ...
                            <ol className="text privacy-section">
                                ...
                                <br />
                                <li>
                                    To the extent that Our liability is not otherwise excluded by these Terms of Use, subject to any Non-Excludable Guarantees, Our liability to You is limited to $200.
                                </li>
                                <br />
                            </ol>
                        </li>
                        ...
                        <li className="heading-privacy">
                            ...
                            <ol className="text privacy-section">
                                ...
                                <br />
                                <li>
                                    Termination  of these Terms of Use and access to the Website does not affect any accrued rights of either party.
                                </li>
                                <br />
                            </ol>
                        </li>
                        ...
                        <li className="heading-privacy">
                            ...
                            <ol className="text privacy-section">
                                ...
                                <br />
                                <li>
                                    Any notice issued by post shall be deemed delivered 6 Business Days after posting if posted domestically, or 10 Business Days after posting if posted internationally.
                                </li>
                                <br />
                                <li>
                        ...
                        <li className="heading-privacy">
                            ...
                            <ol className="text privacy-section">
                                ...
                                <br />
                                <li>
                                    Asignment: You may not assign, transfer, license or novate Your rights or obligations under these Terms of Use without Our prior written consent. We may assign, transfer, license or novate Our rights or obligations under these Terms of Use at any time.
                                </li>
                                <br />
                                <li>
                                ...
                                <br />
                                <li>
                                    Entire Agreement: These Terms of Use constitute the entire agreement between You and Us regarding this Website.
                                </li>
                                <br />
                                <li>
                                    Jurisdiction: These Terms of Use will be interpreted in accordance with the laws in force in Queensland. You and Us irrevocably submit to the non-exclusive jurisdiction of the courts situated in Queensland.
                                </li>
                                <br />
                            </ol>
                        </li>
                        ...
                        <li className="heading-privacy">
                            ...
                            <ol className="text privacy-section">
                                ...
                                <p>
                                    We, Our and Us means Creese Property Pty Ltd.
                                </p>
                                <br />
                                <p>
                                ...
                                <br />
                                <p>
                                    (f) A reference to time is to time in Queensland.
                                </p>
                                <br />
                                <p>
