...
import mainInitialImage from "../assets/ipswich.png";
    ...
    return (
        <section className="section location">
            ...
            <div className="initial-image">
                <img src={locationInfo.mainImage} alt="Ipswich" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
