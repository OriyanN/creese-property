        ...
        <div className="divider-section">
            ...
            <div className="services">
                <div className="service home-promise">
                    <img src="src/assets/service1.png" height={100} alt="Creese Property Experience" />
                ...
                <div className="service home-promise">
                    <img src="src/assets/service2.png" height={100} alt="Creese Property Off Market Deals" />
                ...
                <div className="service home-promise">
                    <img src="src/assets/service3.png" height={100} alt="Creese Property Specialisation" />
                    <h3>Authenticity</h3>
