        ...
        <div className="divider-section">
            ...
            <div className="services">
                <div className="service home-promise">
                    <img src="src/assets/1 copy 2.png" height={'10rem'} alt="Creese Property Experience" />
                ...
                <div className="service home-promise">
                    <img src="src/assets/2 copy 2.png" height={'10rem'} alt="Creese Property Off Market Deals" />
                ...
                <div className="service home-promise">
                    <img src="src/assets/3 copy 2.png" height={'10rem'} alt="Creese Property Specialisation" />
                    <h3>Authenticity</h3>
