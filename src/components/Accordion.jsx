...
const landlordFAQs = [
  { question: "What area does Creese Property service?", answer: "Creese Property services properties across...", open: false },
  { question: "What should I look out for when choosing a property manager?", answer: "The right property manager will have...", open: false },
];

const tenantFAQs = [
  { question: "What legal compliances does Creese Property manage for property owners?", answer: "We ensure all properties...", open: false },
];
