...
const images = [
    ...
    { id: 3, url: LoganProperty, address: '506-514 Beenleigh Redland Bay Road, Carbrook', description: 'Lorem ipsum dolor sit amet consectetur adipiscing elit.', link: '/locations/gold-coast/properties/log1' },
    { id: 4, url: IpswichProperty, address: '22 Kingsmill Road, Coalfalls', description: 'Lorem ipsum dolor sit amet consectetur adipiscing elit.', link: '/locations/gold-coast/properties/ips1' },
];
        ...
        <div className="container">
            <div className="slider">
                {items.map((item, index) => (
                    <div key={item.id} onClick={handleNext} className="item" aria-label={item.address} alt={item.address} style={{ backgroundImage: `url(${item.url})` }}>
